...
const TermsAndConditions = () => {
  return (
    <section className="container mx-auto px-4 md:px-20 py-10 md:py-20 privacy-terms">
      <div className="relative mb-16">
        <div
          ...
          style={{ backgroundImage: `url('/Group 163-3.png')` }}
        >
          <div className="flex flex-col items-center justify-center gap-10">
            <h1
              className="text-4xl md:text-6xl text-white text-center z-10 font-archivo font-semibold"
