...
import twitter from "../public/icon-x.png";
import llinkedin from "../public/icon-llinkedin.png";
import mail from "../public/icon-mail.png";
import git from "../public/icon-git.png"; 
import Image from "next/image";
import RTlogo from "../public/footer-logo.png";
...
const Footer = () => {
  ...
  return (
    <footer className="bg-white px-10 py-16 max-w-[1690px] mx-auto">
       <div className="mx-auto bg-[#EDF4F4] rounded-[40px] px-6 sm:px-8 lg:px-14 py-10 sm:py-12 lg:py-16">
